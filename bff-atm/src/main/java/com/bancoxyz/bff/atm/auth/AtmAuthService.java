...
public class AtmAuthService {
    ...
    public AtmAuthResponse autenticar(AtmAuthRequest request) {

        if (!username.equals(request.username())
                || !password.equals(request.password())) {

            throw new BadCredentialsException(
                    "Credenciales ATM incorrectas"
            );
        }
